...
console.log(lab1.questionOne()); 
// returns and outputs: {}
console.log(lab1.questionOne([97, 7, 83])); // extra function 1
console.log(lab1.questionOne([23, 1, 51]));  // extra function 2
...
console.log(lab1.questionTwo([15, 3, 9])); // extra function 1
console.log(lab1.questionTwo([7, 7, 10])); // extra function 2
...
console.log(lab1.questionThree("No protectors here. No Lanterns. No Kryptonian. This world will fall, like all the others." )); // extra function 1
console.log(lab1.questionThree("my name is barry allen and i am the fastest man alive" )); // extra function 2
...
console.log(lab1.questionFour(40000, 3.6, 4)); // extra function 1
console.log(lab1.questionFour(60000, 4.1, 5)); // extra function 2
